...
class Container_b7ac349547 extends _PHPStan_95cdbe577\Nette\DI\Container
{
	protected $tags = [
	...
	protected $types = ['container' => '_PHPStan_95cdbe577\Nette\DI\Container'];
	protected $aliases = [];

	protected $wiring = [
		'_PHPStan_95cdbe577\Nette\DI\Container' => [['container']],
		'PHPStan\Rules\Rule' => [
			[
				'0109',
				'0110',
		...
		'Luminova\Config\PHPStanRules' => [['0380']],
	];
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'mixinExcludeClasses' => [],
			'scanFiles' => [],
			'scanDirectories' => ['/Applications/XAMPP/xamppfiles/htdocs/luminova.com/samples'],
			'parallel' => [
				'jobSize' => 20,
			...
			'memoryLimitFile' => '/Applications/XAMPP/xamppfiles/htdocs/luminova.com/build/phpstan/.memory_limit',
			'tempResultCachePath' => '/Applications/XAMPP/xamppfiles/htdocs/luminova.com/build/phpstan/resultCaches',
			'resultCachePath' => '/Applications/XAMPP/xamppfiles/htdocs/luminova.com/build/phpstan/resultCache.php',
			...
			'__validate' => true,
			'tmpDir' => '/Applications/XAMPP/xamppfiles/htdocs/luminova.com/build/phpstan',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/Applications/XAMPP/xamppfiles/htdocs/luminova.com/build/phpstan',
			...
			'fixerTmpDir' => '/var/folders/hx/w6fns9bx5s11b4p0s2n0l_fw0000gn/T/phpstan-fixer',
	...
	public function createService047(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_b7ac349547 $container)
			{
			...
			public function create(): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/Applications/XAMPP/xamppfiles/htdocs/luminova.com/build/phpstan/resultCache.php',
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/Applications/XAMPP/xamppfiles/htdocs/luminova.com/build/phpstan/resultCache.php');
	}
	...
	public function createService054(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			'/Applications/XAMPP/xamppfiles/htdocs/luminova.com',
			'/var/folders/hx/w6fns9bx5s11b4p0s2n0l_fw0000gn/T/phpstan-fixer',
			['1.1.1.2']
		);
	}
	...
	public function createService061(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/Applications/XAMPP/xamppfiles/htdocs/luminova.com',
			'/Applications/XAMPP/xamppfiles/htdocs/luminova.com/build/phpstan',
			[
				'phar:///Applications/XAMPP/xamppfiles/htdocs/luminova.com/system/plugins/phpstan/phpstan/phpstan.phar/conf/config.level6.neon',
				'/Applications/XAMPP/xamppfiles/htdocs/luminova.com/phpstan.neon',
			],
	...
	public function createService0380(): Luminova\Config\PHPStanRules
	{
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/Applications/XAMPP/xamppfiles/htdocs/luminova.com/build/phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_b7ac349547
	{
		return $this;
	}
