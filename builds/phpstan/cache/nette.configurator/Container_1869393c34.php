...
class Container_1869393c34 extends _PHPStan_d5c599c96\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'Luminova\Config\PHPStanRules' => [['0383']],
	];
	...
	public function createService047(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_1869393c34 $container)
			{
	...
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchCheck($this->getService('0141'), false, false);
	}
	...
	{
		return new PHPStan\Rules\Comparison\ConstantConditionRuleHelper($this->getService('0109'), false, false);
	}
	...
	{
		return new PHPStan\Rules\IssetCheck($this->getService('0139'), $this->getService('0140'), true, false, false);
	}
	...
	{
		return new PHPStan\Rules\Functions\CallCallablesRule($this->getService('0117'), $this->getService('0141'), false);
	}
	...
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule($this->getService('0141'), false);
	}
	...
	{
		return new PHPStan\Rules\Generators\YieldFromTypeRule($this->getService('0141'), false);
	}
	...
	{
		return new PHPStan\Rules\Comparison\BooleanAndConstantConditionRule($this->getService('0108'), false, false, false);
	}


	public function createService0356(): PHPStan\Rules\Comparison\BooleanOrConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanOrConstantConditionRule($this->getService('0108'), false, false, false);
	}


	public function createService0357(): PHPStan\Rules\Comparison\BooleanNotConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanNotConstantConditionRule($this->getService('0108'), false, false);
	}
	...
	{
		return new PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule($this->getService('0108'), false);
	}


	public function createService0360(): PHPStan\Rules\Comparison\ElseIfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\ElseIfConstantConditionRule($this->getService('0108'), false, false);
	}


	public function createService0361(): PHPStan\Rules\Comparison\IfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\IfConstantConditionRule($this->getService('0108'), false);
	}


	public function createService0362(): PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule($this->getService('0109'), false, false, false);
	}


	public function createService0363(): PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule($this->getService('0109'), false, false, false);
	}


	public function createService0364(): PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule($this->getService('0109'), false, false, false);
	}


	public function createService0365(): PHPStan\Rules\Comparison\MatchExpressionRule
	{
		return new PHPStan\Rules\Comparison\MatchExpressionRule($this->getService('0108'), false, false, false, false);
	}
	...
	{
		return new PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule($this->getService('0108'), false);
	}


	public function createService0370(): PHPStan\Rules\Comparison\UnreachableIfBranchesRule
	{
		return new PHPStan\Rules\Comparison\UnreachableIfBranchesRule($this->getService('0108'), false, false);
	}


	public function createService0371(): PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule
	{
		return new PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule($this->getService('0108'), false, false);
	}


	public function createService0372(): PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule($this->getService('0108'), false);
	}


	public function createService0373(): PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule($this->getService('0108'), false);
	}
	...
	public function createService0383(): Luminova\Config\PHPStanRules
	{
	...
	public function createServiceContainer(): Container_1869393c34
	{
		return $this;
	}
